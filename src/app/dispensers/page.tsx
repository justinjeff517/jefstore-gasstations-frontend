      ...
      <main className="mx-auto w-full max-w-md px-4 pb-24 pt-6">
        ...
        <section className="grid grid-cols-2 gap-4">
          {tiles.map(({ href, label, Icon }) => (
            <Link key={href} href={href} className="focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50">
              <Card className="flex flex-col items-center justify-center p-6 hover:bg-accent">
                <Icon size={28} strokeWidth={2} className="mb-2" aria-hidden="true" />
